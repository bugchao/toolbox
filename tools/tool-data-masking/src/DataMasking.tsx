          ...
          <div className="px-4 pb-4 border-t border-gray-100 dark:border-gray-700 pt-3 space-y-3">
            <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr_auto_1fr_auto] gap-2">
              ...
              <input
                ...
                className="px-2 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 font-mono focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
              <input
                type="text"
                value={draft.flags}
                ...
                placeholder="g"
                className="w-16 px-2 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 font-mono focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
              <input
                type="text"
            ...
            {draftError && (
              <p className="text-xs text-red-600 dark:text-red-400 font-mono">{draftError}</p>
            )}
            <p className="text-xs text-gray-400 dark:text-gray-500">{t('custom.hint')}</p>
            {data.customRules.length > 0 ? (
                ...
                {data.customRules.map((c) => {
                  ...
                  return (
                    <li key={c.id} className="py-2 flex items-start gap-2 text-sm">
                      ...
                      {hits > 0 && c.enabled && (
                        <span className="text-xs text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/30 border border-indigo-200 dark:border-indigo-800 px-2 py-0.5 rounded-full">
                          ×{hits}
                        </span>
                      )}
                      <button
              ...
              <p className="text-xs text-gray-400 dark:text-gray-500">{t('custom.empty')}</p>
            )}
          </div>
        )}
      </section>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={() => setInput('')}
              className="text-xs text-gray-500 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-400 inline-flex items-center gap-1"
            >
          ...
          <textarea
            ...
            className="w-full h-[460px] px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 font-mono focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none"
            spellCheck={false}
          />
        </div>
        <div className="space-y-2">
          ...
          <textarea
            ...
            className="w-full h-[460px] px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md font-mono bg-gray-50 dark:bg-gray-900/50 text-gray-900 dark:text-gray-100 resize-none"
            spellCheck={false}
          />
        </div>
      </section>
