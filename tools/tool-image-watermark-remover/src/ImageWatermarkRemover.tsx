              ...
              {images.map(image => (
                ...
                >
                  ...
                  <button
                    ...
                    className="p-1 text-ink-subtle hover:text-red-500 dark:hover:text-red-400"
                  >
                    <X className="w-4 h-4" />
                  </button>
                </div>
            ...
            <div className="mt-4 bg-surface rounded-lg shadow p-4">
                  ...
                  {(['standard', 'fine', 'large'] as RepairMode[]).map((mode) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="mt-1 text-xs text-ink-muted">{config.description}</div>
                      </button>
                    );
                  })}
                </div>
              ...
              <div className="space-y-2">
                ...
                <button
                  ...
                  className="w-full px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 disabled:bg-gray-400 dark:disabled:bg-gray-700 flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  className="w-full px-4 py-2 bg-violet-500 text-white rounded-lg hover:bg-violet-600 disabled:bg-gray-400 dark:disabled:bg-gray-700 flex items-center justify-center gap-2"
                >
        ...
        <div className="lg:col-span-3">
          {selectedImage ? (
            <div className="bg-surface rounded-lg shadow p-6">
              ...
              {/* Canvas */}
              <div className="mb-4 bg-surface-inset rounded-lg overflow-hidden">
                <canvas
                  ref={canvasRef}
              ...
              {maskPoints.length > 0 && (
                <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg flex items-center gap-2">
                  <Circle className="w-4 h-4 text-red-500 dark:text-red-400" />
