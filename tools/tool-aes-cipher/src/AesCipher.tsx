    ...
    <div className="w-full space-y-6 pb-24">
      ...
      <section className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4 space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div>
            <label className="block text-xs text-gray-500 dark:text-gray-400 mb-1">{t('field.mode')}</label>
            <select
              value={data.mode}
              onChange={(e) => update('mode', e.target.value as AesMode)}
              className="w-full px-2 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            >
          ...
          <div>
            <label className="block text-xs text-gray-500 dark:text-gray-400 mb-1">{t('field.bits')}</label>
            <select
              value={data.bits}
          ...
          <div>
            <label className="block text-xs text-gray-500 dark:text-gray-400 mb-1">{t('field.direction')}</label>
          ...
          <div className="inline-flex border border-gray-300 dark:border-gray-600 rounded-md overflow-hidden">
            <button
              ...
              className={`px-3 py-1 text-xs ${
                data.keySource === 'passphrase' ? 'bg-indigo-600 text-white' : 'bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300'
              }`}
            >
              {t('key.passphrase')}
            </button>
            <button
              ...
              className={`px-3 py-1 text-xs ${
                data.keySource === 'raw' ? 'bg-indigo-600 text-white' : 'bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300'
              }`}
            >
              {t('key.raw')}
            </button>
          ...
          <>
            <div className="relative">
              <input
                ...
                className="w-full pr-10 px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 font-mono focus:outline-none focus:ring-2 focus:ring-indigo-500"
                autoComplete="off"
                spellCheck={false}
              />
              <button
            ...
            <div className="grid grid-cols-1 sm:grid-cols-[1fr_auto_auto] gap-2 items-center">
              <input
                ...
                className="px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 font-mono focus:outline-none focus:ring-2 focus:ring-indigo-500"
                spellCheck={false}
              />
              <button
                type="button"
                onClick={generateRandomSalt}
                className="px-2 py-1.5 text-xs text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 flex items-center gap-1"
              ...
              <input
                ...
                className="w-28 px-2 py-1.5 text-xs border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 font-mono focus:outline-none focus:ring-2 focus:ring-indigo-500"
                title={t('key.iterationsTitle')}
              />
            </div>
            <p className="text-xs text-gray-400 dark:text-gray-500">{t('key.passphraseHint')}</p>
          </>
        ) : (
          <>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <textarea
            ...
            className="w-full h-64 px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 font-mono focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none"
            spellCheck={false}
          />
        </div>
        <div className="space-y-2">
          ...
          <textarea
            ...
            className="w-full h-64 px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md font-mono bg-gray-50 dark:bg-gray-900/50 text-gray-900 dark:text-gray-100 resize-none"
            spellCheck={false}
          />
        </div>
      </section>
        ...
        {options.map((o) => (
          <button
            ...
            className={`px-2 py-1 text-xs uppercase ${
              value === o ? 'bg-indigo-600 text-white' : 'bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700'
            }`}
          >
            {o}
          </button>
