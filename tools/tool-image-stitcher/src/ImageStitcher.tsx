      ...
      {images.length > 0 && (
        <div className="mb-6 bg-surface rounded-lg shadow p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              onClick={clearAll}
              className="text-sm text-red-500 dark:text-red-400 hover:text-red-600 dark:hover:text-red-300 flex items-center gap-1"
            >
              ...
              <div key={image.id} className="relative group">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-50 transition flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100">
                  <button
                    ...
                    disabled={index === 0}
                    className="p-2 bg-surface rounded-full disabled:opacity-50"
                    title="上移"
                  >
