      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full h-48 p-4 border border-edge-strong rounded-md font-mono text-sm bg-surface-muted focus:outline-none focus:ring-2 focus:ring-indigo-500"
          />
        </div>
