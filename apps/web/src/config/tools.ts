...
import {
  ...
  MapPinned, Map, Milestone, Flag, Signpost, Waypoints,
  Glasses, Microscope, FlaskConical, TestTube, Atom, Beaker,
  Bike, Car, Train, Bus, Boat, Plane,
  ...
  Watch, Hourglass, Stopwatch, CalendarClock, CalendarCheck,
  ...
  Settings, Settings2, Cog, Wrench, Hammer, Screwdriver,
...
export const TOOLS: ToolEntry[] = [
  ...
  { path: '/dns-global-check', nameKey: 'tools.dns_global_check', icon: Map, categoryKey: 'dns', keywords: ['dns', '全球', '解析', '检测'], i18nNamespace: 'toolDnsGlobalCheck' , mode: 'server'},
  ...
  { path: '/pomodoro-pro', nameKey: 'tools.pomodoro_pro', icon: Stopwatch, categoryKey: 'life', keywords: ['番茄钟', '专注', 'pomodoro', '计时'], i18nNamespace: 'toolPomodoroPro' },
