...
export const TOOLS: ToolEntry[] = [
  ...
  { path: '/ip-query', nameKey: 'tools.ip_query', icon: Globe, categoryKey: 'ip', keywords: ['ip'], i18nNamespace: 'toolIpQuery' },
  { path: '/ip-asn', nameKey: 'tools.ip_asn', icon: Globe, categoryKey: 'ip', keywords: ['asn', 'as', '归属'], i18nNamespace: 'toolIpAsn' },
  { path: '/dns-query', nameKey: 'tools.dns_query', icon: Server, categoryKey: 'dns', keywords: ['dns', '域名', '解析'] },
  { path: '/dns-trace', nameKey: 'tools.dns_trace', icon: Route, categoryKey: 'dns', keywords: ['dns', 'trace', '递归', '追踪'], i18nNamespace: 'toolDnsTrace' },
  { path: '/dns-propagation', nameKey: 'tools.dns_propagation', icon: Globe, categoryKey: 'dns', keywords: ['dns', 'propagation', '传播', '检测'], i18nNamespace: 'toolDnsPropagation' },
  { path: '/dns-global-check', nameKey: 'tools.dns_global_check', icon: Globe, categoryKey: 'dns', keywords: ['dns', '全球', '解析', '检测'], i18nNamespace: 'toolDnsGlobalCheck' },
  { path: '/dnssec-check', nameKey: 'tools.dnssec_check', icon: ShieldCheck, categoryKey: 'dns', keywords: ['dns', 'dnssec', '签名', '校验'], i18nNamespace: 'toolDnssecCheck' },
  { path: '/dns-performance', nameKey: 'tools.dns_performance', icon: Activity, categoryKey: 'dns', keywords: ['dns', '性能', '响应', '可用性'], i18nNamespace: 'toolDnsPerformance' },
  { path: '/dns-ttl', nameKey: 'tools.dns_ttl', icon: Clock, categoryKey: 'dns', keywords: ['dns', 'ttl', '缓存'], i18nNamespace: 'toolDnsTtl' },
  { path: '/dns-soa', nameKey: 'tools.dns_soa', icon: Server, categoryKey: 'dns', keywords: ['dns', 'soa', '解析'], i18nNamespace: 'toolDnsSoa' },
  { path: '/dns-diagnose', nameKey: 'tools.dns_diagnose', icon: ShieldAlert, categoryKey: 'dns', keywords: ['dns', 'diagnose', '诊断', '失败'], i18nNamespace: 'toolDnsDiagnose' },
  { path: '/dns-pollution-check', nameKey: 'tools.dns_pollution_check', icon: AlertTriangle, categoryKey: 'dns', keywords: ['dns', 'pollution', '污染', '检测'], i18nNamespace: 'toolDnsPollutionCheck' },
  { path: '/dns-hijack-check', nameKey: 'tools.dns_hijack_check', icon: ShieldCheck, categoryKey: 'dns', keywords: ['dns', 'hijack', '劫持', '检测'], i18nNamespace: 'toolDnsHijackCheck' },
  { path: '/dns-cache-check', nameKey: 'tools.dns_cache_check', icon: Clock, categoryKey: 'dns', keywords: ['dns', 'cache', '缓存', 'ttl'], i18nNamespace: 'toolDnsCacheCheck' },
  { path: '/dns-loop-check', nameKey: 'tools.dns_loop_check', icon: RefreshCw, categoryKey: 'dns', keywords: ['dns', 'loop', '循环', 'cname'], i18nNamespace: 'toolDnsLoopCheck' },
  { path: '/dns-ns', nameKey: 'tools.dns_ns', icon: Server, categoryKey: 'dns', keywords: ['dns', 'ns', '名称服务器', 'nameserver'], i18nNamespace: 'toolDnsNs' },
  { path: '/dns-cname-chain', nameKey: 'tools.dns_cname_chain', icon: Link2, categoryKey: 'dns', keywords: ['dns', 'cname', '链', 'chain', '循环'], i18nNamespace: 'toolDnsCnameChain' },
  { path: '/dns-nxdomain', nameKey: 'tools.dns_nxdomain', icon: XCircle, categoryKey: 'dns', keywords: ['dns', 'nxdomain', '域名', '不存在'], i18nNamespace: 'toolDnsNxdomain' },
  { path: '/domain-mx', nameKey: 'tools.domain_mx', icon: Mail, categoryKey: 'domain', keywords: ['mx', '邮件', 'mail', '邮箱'], i18nNamespace: 'toolDomainMx' },
  { path: '/domain-txt', nameKey: 'tools.domain_txt', icon: FileText, categoryKey: 'domain', keywords: ['txt', 'spf', 'dkim', 'dmarc', '记录'], i18nNamespace: 'toolDomainTxt' },
  ...
  { path: '/domain-ttl-advice', nameKey: 'tools.domain_ttl_advice', icon: Clock, categoryKey: 'domain', keywords: ['ttl', 'domain', '缓存', '优化'], i18nNamespace: 'toolDomainTtlAdvice' },
  { path: '/domain-ns-check', nameKey: 'tools.domain_ns_check', icon: Server, categoryKey: 'domain', keywords: ['ns', 'nameserver', '权威'], i18nNamespace: 'toolDomainNsCheck' },
  { path: '/domain-subdomain-scan', nameKey: 'tools.domain_subdomain_scan', icon: Search, categoryKey: 'domain', keywords: ['subdomain', 'scan', '子域'], i18nNamespace: 'toolDomainSubdomainScan' },
  { path: '/domain-wildcard', nameKey: 'tools.domain_wildcard', icon: Route, categoryKey: 'domain', keywords: ['wildcard', 'dns', '泛解析'], i18nNamespace: 'toolDomainWildcard' },
  { path: '/domain-health-score', nameKey: 'tools.domain_health_score', icon: Activity, categoryKey: 'domain', keywords: ['health', 'score', 'domain', '健康'], i18nNamespace: 'toolDomainHealthScore' },
  { path: '/ip-geo', nameKey: 'tools.ip_geo', icon: Globe, categoryKey: 'ip', keywords: ['geo', 'ip', 'location', '地理'], i18nNamespace: 'toolIpGeo' },
  { path: '/ip-ptr', nameKey: 'tools.ip_ptr', icon: Fingerprint, categoryKey: 'ip', keywords: ['ptr', 'reverse', 'rdns'], i18nNamespace: 'toolIpPtr' },
  ...
  { path: '/ip-cdn-check', nameKey: 'tools.ip_cdn_check', icon: Radar, categoryKey: 'ip', keywords: ['cdn', 'edge', 'ip', '节点'], i18nNamespace: 'toolIpCdnCheck' },
  { path: '/ip-blacklist', nameKey: 'tools.ip_blacklist', icon: ShieldBan, categoryKey: 'ip', keywords: ['ip', 'blacklist', 'dnsbl', '黑名单'], i18nNamespace: 'toolIpBlacklist' },
  { path: '/security-ip-score', nameKey: 'tools.security_ip_score', icon: ShieldAlert, categoryKey: 'security', keywords: ['security', 'ip', 'risk', '安全', '评分'], i18nNamespace: 'toolSecurityIpScore' },
  { path: '/security-domain-blacklist', nameKey: 'tools.security_domain_blacklist', icon: ShieldBan, categoryKey: 'security', keywords: ['security', 'domain', 'blacklist', '域名', '黑名单'], i18nNamespace: 'toolSecurityDomainBlacklist' },
  { path: '/security-port-scan', nameKey: 'tools.security_port_scan', icon: Radar, categoryKey: 'security', keywords: ['security', 'port', 'scan', '端口', '扫描'], i18nNamespace: 'toolSecurityPortScan' },
  { path: '/security-dns-vuln', nameKey: 'tools.security_dns_vuln', icon: ShieldCheck, categoryKey: 'security', keywords: ['security', 'dns', 'vuln', '漏洞', '配置'], i18nNamespace: 'toolSecurityDnsVuln' },
  { path: '/security-report-gen', nameKey: 'tools.security_report_gen', icon: FileSearch, categoryKey: 'security', keywords: ['security', 'report', '网络', '报告'], i18nNamespace: 'toolSecurityReportGen' },
  { path: '/ipam-plan', nameKey: 'tools.ipam_plan', icon: Boxes, categoryKey: 'ipam', keywords: ['ipam', 'plan', 'vlsm', '规划'], i18nNamespace: 'toolIpamPlan' },
  { path: '/ipam-inventory', nameKey: 'tools.ipam_inventory', icon: Boxes, categoryKey: 'ipam', keywords: ['ipam', 'inventory', '库存'], i18nNamespace: 'toolIpamInventory' },
  { path: '/ipam-usage', nameKey: 'tools.ipam_usage', icon: Activity, categoryKey: 'ipam', keywords: ['ipam', 'usage', 'utilization', '使用率'], i18nNamespace: 'toolIpamUsage' },
  { path: '/ipam-conflict', nameKey: 'tools.ipam_conflict', icon: GitCompareArrows, categoryKey: 'ipam', keywords: ['ipam', 'conflict', 'overlap', '冲突'], i18nNamespace: 'toolIpamConflict' },
  { path: '/ipam-allocation-sim', nameKey: 'tools.ipam_allocation_sim', icon: PlayCircle, categoryKey: 'ipam', keywords: ['ipam', 'allocation', 'simulation', '分配'], i18nNamespace: 'toolIpamAllocationSim' },
