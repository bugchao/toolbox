...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@toolbox/tool-expense-tracker': path.join(root, 'tools/tool-expense-tracker'),
      '@toolbox/tool-subscription-manager': path.join(root, 'tools/tool-subscription-manager'),
      '@toolbox/tool-calorie-calc': path.join(root, 'tools/tool-calorie-calc'),
      '@toolbox/tool-random-menu': path.join(root, 'tools/tool-random-menu'),
      '@toolbox/tool-curl-to-fetch': path.join(root, 'tools/tool-curl-to-fetch'),
      '@toolbox/tool-installment-calc': path.join(root, 'tools/tool-installment-calc'),
      '@toolbox/tool-okr-planner': path.join(root, 'tools/tool-okr-planner'),
      '@toolbox/tool-travel-checklist': path.join(root, 'tools/tool-travel-checklist'),
      '@toolbox/tool-travel-budget': path.join(root, 'tools/tool-travel-budget'),
      '@toolbox/tool-split-bill': path.join(root, 'tools/tool-split-bill'),
      '@toolbox/tool-timezone-calc': path.join(root, 'tools/tool-timezone-calc'),
      '@toolbox/tool-distance-calc': path.join(root, 'tools/tool-distance-calc'),
      '@toolbox/tool-packing-list': path.join(root, 'tools/tool-packing-list'),
      '@toolbox/tool-recipe-finder': path.join(root, 'tools/tool-recipe-finder'),
      '@toolbox/tool-study-timer': path.join(root, 'tools/tool-study-timer'),
      '@toolbox/storage': path.join(root, 'packages/storage'),
